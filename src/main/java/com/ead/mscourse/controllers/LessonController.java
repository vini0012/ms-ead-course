...
import com.ead.mscourse.dtos.LessonDto;
...
public class LessonController {
    ...
    public ResponseEntity<Page<LessonModel>> getAllModules(@PathVariable(value = "moduleId") UUID moduleId,
    ...
    public ResponseEntity<Object> getOneLesson(@PathVariable(value = "moduleId") UUID moduleId,
        ...
        return lessonModelOptional.<ResponseEntity<Object>>map(courseModel ->
