package com.ead.mscourse.controllers;

import com.ead.mscourse.dtos.CourseDto;
import com.ead.mscourse.dtos.ModuleDto;
...
import com.ead.mscourse.specifications.SpecificationTemplate;
...
public class ModuleController {
    ...
    public ResponseEntity<Object> getOneModule(@PathVariable(value = "courseId") UUID courseId,
        ...
        return moduleModelOptional.<ResponseEntity<Object>>map(courseModel ->
                ResponseEntity.status(HttpStatus.OK).body(courseModel)).orElseGet(() ->
                ResponseEntity.status(HttpStatus.NOT_FOUND).body("Module Not Found"));
    }
}
